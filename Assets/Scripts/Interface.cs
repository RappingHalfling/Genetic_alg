...
public class Interface : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        SampleCount = GenController.GetComponent<GenAlg>().SamplesPerGeneration;
    ...
    {
        DrawInfo();
        StatsPanel.GetChild(0).GetComponentInChildren<Text>().text = "Generation#" + GenController.GetComponent<GenAlg>().GenNum;
    ...
    public void DrawInfo()
    {
        for (int i = 0; i < SampleCount; i++)
        {
            ...
            CarBrain Car = GenController.transform.GetChild(i).GetComponent<CarBrain>();
            curText.text = "№" + i + "| Fitness:" + Car.fitnessRate + "| Death:" + Car.IamStone;
            if (!Car.IamStone)
            {
                curText.color = new Color(0, 0, 0);
            }
            else {
                curText.color = new Color(160, 0, 0);
            }
        }
    }
}
